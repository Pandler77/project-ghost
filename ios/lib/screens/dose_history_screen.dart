      ...
      builder: (context) {
        return ListView(
          ...
          children: [
            ...
            ListTile(
              leading: const Icon(ArcticIcons.apps_rounded),
        ...
        child: Ink(
          ...
          child: Row(
            children: [
              ...
              Icon(ArcticIcons.tune_rounded, size: 18, color: colors.primary),
            ],
          ),
        ),
      ),
...
class _DoseHistoryRow extends StatelessWidget {
  ...
  IconData _statusIcon(DoseRecordStatus status) {
    switch (status) {
      ...
      case DoseRecordStatus.missed:
        return ArcticIcons.priority_high_rounded;
    }
  }
      ...
      child: Column(
        children: [
          Container(
            ...
            child: Icon(ArcticIcons.history_rounded, size: 28, color: colors.primary),
          ),
          const SizedBox(height: AppSpacing.md),
          const Text(
            'No dose history yet',
