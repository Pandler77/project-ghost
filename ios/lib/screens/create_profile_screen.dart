      ...
      builder: (sheetContext) {
        return SafeArea(
          child: Column(
            ...
            children: [
              ListTile(
                leading: const Icon(ArcticIcons.camera_alt_outlined),
              ...
              ListTile(
                leading: const Icon(ArcticIcons.account_circle_outlined),
              ...
              if (_avatarImagePath != null || _selectedAvatarId != null)
                ListTile(
                  leading: const Icon(ArcticIcons.delete_outline),
          ...
          children: [
            ...
            SizedBox(
              ...
              child: FilledButton.icon(
                onPressed: _save,
                icon: const Icon(ArcticIcons.person_add_outlined),
