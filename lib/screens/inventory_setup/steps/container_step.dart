    ...
    return Column(
      ...
      children: [
        const StepHeader(
          ...
          subtitle: 'Tell Ghost what each container is and how much it holds.',
          currentStep: 2,
          totalSteps: 7,
        ),
            ...
            children: [
              ...
              Text(
                widget.preset == null
                    ...
                    : 'Ghost filled in a common starting point. Change anything that does not match your supply.',
