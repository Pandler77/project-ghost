...
import 'about_ghost_screen.dart';
...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Future<void> _openAboutGhost() async {
    await Navigator.push<void>(
      context,
      MaterialPageRoute(builder: (_) => const AboutGhostScreen()),
    );
  }
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Choose how measurements are displayed throughout Ghost.',
                  style: TextStyle(
  ...
  Future<void> _resetAppData() async {
    ...
    final continueReset = await showDialog<bool>(
      ...
      builder: (dialogContext) {
        return AlertDialog(
          ...
          title: const Text('Reset all Ghost data?'),
          content: const Text(
            'This permanently deletes protocols, dose history, weight data, '
            'Ghost Supply, progress photos, symptoms, profiles, and local '
          ...
          builder: (context, setDialogState) {
            ...
            return AlertDialog(
              ...
              content: Column(
                ...
                children: [
                  const Text(
                    'This is the final confirmation. All local Ghost data '
                    'will be erased.',
                  ),
                  const SizedBox(height: AppSpacing.md),
                  TextField(
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Could not reset Ghost data: $error')),
      );
    }
  }
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (dialogContext) {
        return AlertDialog(
          ...
          content: const Text(
            'Ghost will show onboarding again the next time the onboarding flow is checked.',
          ),
          actions: [
            TextButton(
              onPressed: () {
  ...
  Future<void> _resetGhostSupplyBeta() async {
    final confirmed = await showDialog<bool>(
      context: context,
      builder: (dialogContext) {
        return AlertDialog(
          title: const Text('Reset Ghost Supply beta notice?'),
          content: const Text(
            'The Ghost Supply beta notice will be allowed to appear again.',
          ),
          actions: [
            TextButton(
              onPressed: () {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Ghost Supply beta notice reset.')),
    );
  }
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            const _SettingsSectionHeader(
              title: 'Preferences',
              subtitle: 'Control how Ghost looks, tracks, and displays data.',
            ),
                        ...
                        return Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: AppSpacing.xs),
                              Text(
                                'Choose how Ghost appears on this device.',
                                style: TextStyle(
                                  fontSize: AppTypography.caption,
                                  color: Theme.of(
                                    context,
            ...
            const _SettingsSectionHeader(
              title: 'Data & Privacy',
              subtitle: 'Manage and protect your Ghost data.',
            ),
            ...
            _SettingsCard(
              children: [
                const _ComingSoonTile(
                  ...
                  title: 'Export Data',
                  subtitle: 'Export a copy of your Ghost data.',
                ),
                ...
                const _ComingSoonTile(
                  ...
                  subtitle: 'Protect and restore your Ghost data.',
                ),
                ...
                _SettingsTile(
                  ...
                  title: 'Privacy',
                  subtitle: 'Review how Ghost stores and uses your data.',
                  onTap: _openPrivacy,
                ),
                ...
                _SettingsTile(
                  ...
                  subtitle: _isResettingAppData
                      ? 'Resetting Ghost...'
                      : 'Erase locally stored Ghost data.',
            ...
            _SettingsCard(
              children: [
                _SettingsTile(
                  ...
                  title: _hasPremium ? 'Ghost Premium' : 'Upgrade to Premium',
                  subtitle: _hasPremium
                      ? 'Premium features are active.'
                      : 'Unlock analytics, Ghost Supply™, comparisons, and more.',
                  onTap: _openPremium,
                ),
            ...
            _SettingsCard(
              children: [
                ...
                _SettingsTile(
                  ...
                  title: 'Terms of Use',
                  subtitle: 'Review Ghost terms and conditions.',
              ...
              _SettingsCard(
                children: [
                  ...
                  _SettingsTile(
                    ...
                    title: 'Reset Ghost Supply Beta Notice',
                    subtitle:
                        'Allow the Ghost Supply beta notice to appear again.',
                    onTap: _resetGhostSupplyBeta,
                  ),
                ],
              ),
            ],
                  ...
                  children: [
                    ...
                    Text(
                      hasPremium
                          ...
                          : 'Get access to advanced tracking, analytics, Ghost Supply™, and more.',
                      style: TextStyle(
                        fontSize: AppTypography.caption,
                        height: 1.35,
