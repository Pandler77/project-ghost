...
class AboutArcticDoseScreen extends StatelessWidget {
  const AboutArcticDoseScreen({super.key});
            ...
            _AboutCard(
              children: [
                ...
                _AboutRow(
                  ...
                  title: 'Your Data',
                  subtitle:
                      'Tracking data stays associated with your ArcticDose profiles.',
            ...
            _AboutCard(
              children: [
                _AboutActionRow(
                  ...
                  subtitle: 'View licenses for packages used by ArcticDose.',
                  accent: colors.primary,
                  onTap: () {
                    showLicensePage(
                      context: context,
              ...
              child: Column(
                children: [
                  ShaderMask(
                    ...
                    child: const Icon(
                      ArcticIcons.landscape_outlined,
                      size: 24,
                      color: Colors.white,
                    ),
                  ),
                  ...
                  Text(
                    'ArcticDose helps keep your protocols, doses, '
...
class _BrandHero extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          const ArcticDoseLogo(size: 92, borderRadius: 24),
          ...
          RichText(
            ...
            text: TextSpan(
              ...
              children: const [
                ...
                TextSpan(
                  text: 'Dose',
                  style: TextStyle(color: ArcticPalette.purple),
                ),
              ],
            ),
          ),
