        ...
        child: ListView(
          ...
          children: [
            Container(
              ...
              child: const Column(
                ...
                children: [
                  ...
                  Text(
                    'Draft in-app terms for the current pre-release version of Ghost.',
                    style: TextStyle(
            ...
            const _TermsSection(
              ...
              body:
                  'Ghost is a personal organization and tracking application. It is not a medical provider, pharmacy, diagnostic service, or substitute for professional medical advice.',
            ),
            const _TermsSection(
              title: '2. User Responsibility',
              body:
                  'You are responsible for verifying any information you enter into Ghost, including protocol schedules, dose amounts, inventory values, calculator inputs, reminders, and other tracked information.',
            ),
            const _TermsSection(
              title: '3. Calculators',
              body:
            ...
            const _TermsSection(
              title: '7. Changes',
              body:
                  'Ghost features and these terms may change before or after release. The published release version should include the final terms that apply to users.',
            ),
            Container(
              width: double.infinity,
