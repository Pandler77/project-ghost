...
class _ProtocolChoiceCard extends StatelessWidget {
  ...
  static IconData _iconForPreset(InventoryPreset? preset) {
    return switch (preset?.iconName) {
      'science' => ArcticIcons.science_outlined,
      'medication' => ArcticIcons.medication_outlined,
      'fitness' => ArcticIcons.fitness_center_outlined,
      _ => ArcticIcons.inventory_2_outlined,
    };
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          Icon(
            ArcticIcons.search_off_outlined,
            size: 42,
