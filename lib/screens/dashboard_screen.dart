      ...
      if (rolloverCheck?.requiresNewContainer == true) {
        ...
        if (choice.batch != null) {
          ...
          if (createdBatch == null) {
            throw StateError('Ghost could not identify the new batch.');
          }
            ...
            Text(
              item.currentAmount > 0
                  ? 'Your current $containerName has only '
                        ...
                        'Choose which batch Ghost should open next.'
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: AppSpacing.xs),
            Text(
              'Add this batch to Ghost Supply and use it for the rollover.',
